...
export const ui = {
  pl: {
    ...
    "form.submit": "Wyślij",
    "form.send_error": "Wystąpił błąd podczas wysyłania formularza. Możliwe, że jesteś już na liście kontaktowej.",
  ...
  en: {
    ...
    "form.submit": "Send",
    "form.send_error": "An error occurred while sending the form. It is possible that you are already on the contact list.",
